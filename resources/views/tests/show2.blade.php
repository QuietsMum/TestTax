    ...
    <div class="row no-gutter">
        ...
        <div class="col-sm">
                ...
                <div class="container-fluid">
                    <div class="row" style="width:100%">
                        <div class="col-sm-4" style="margin-top:1%">
                            ...
                            <span style="font-size:1.25rem; font-weight:400; color:#000;text-decoration-line: underline; margin-left: 10px;">Тестирование</span>
                        </div>
                        <div class="col-sm-8" style="text-align:right; font-size:1.125rem; font-weight:400">
                            <div class="row" style="float:right;">
                                <div class="col-sm" style="padding-right: unset; padding-left: unset;">
                                    <div class="selectCase2">
                                        <p class="selectCaseText" style="color:#160B50; font-size:1.125rem; font-weight:400; margin-bottom: 0rem; text-align:left">Кейс 1: Государственный служащий («М», ИИН 731201400135), в 2021 году</p>
                                    </div>
                                </div>
                ...
                <div class="whiteBox3" id="formBox" style="  font-family: 'Times New Roman', Times, serif!important;">
                    ...
                    <div class="container">
                        ...
                        <!-- РАЗДЕЛ O -->
                            ...
                            <div style="font-size: 0.8125rem; font-weight: 400; text-align: left; margin-top:20px">
            ...
            <div class="footer2">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <p style="font-size:1.375rem; font-weight:700; text-decoration: underline; color:#D2AB67; margin-top:5%; margin-left: 10px;">#ВМЕСТЕКРАЗВИТИЮ</p>
                        </div>
                        <div class="col-sm-4">
                            <div style="background: #E84A4A;
                            border-radius: 4px;padding: 8px; margin-top: 3%;">
                            <p style="font-size:0.8125rem; font-weight:500; color:#fff; margin-bottom: 0;">У вас есть 20 минут на выполнение теста. 
            ...
            <div class="popupInfo" id="infoA" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел А «Общая информация о налогоплательщике»</p>
            ...
            <div class="popupInfo" id="infoB" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел В «Начисленная сумма полученных  доходов»</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoB1" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 01. Виды дохода, подлежащего налогообложению у источника выплаты (включает доходы согласно статьи 322, 323, 324, 325, 326, 327, 328, 329 Налогового кодекса)</p>
                <p style="font-weight:400; font-size: 1rem;">
                   <ul>
            ...
            <div class="popupInfo" id="infoB2A" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 02А. Имущественный доход (доходы в соответствии со статьей 330 Налогового кодекса):</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoB2B" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 02В. Доход лица, занимающегося частной практикой</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoB2C" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 02С. Доход из источников за пределами Республики Казахстан (статья 338 Налогового кодекса)</p>
                </div>
            ...
            <div class="popupInfo" id="infoB2D" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;"">Строка 02D. Доход индивидуального предпринимателя (статья 338 Налогового кодекса)</p>
                </div>
            ...
            <div class="popupInfo" id="infoC" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел С «Общая сумма корректировки дохода в соответствии со статьей 341 Налогового кодекса» налогоплательщик указывает сумму корректировки при их наличии в отчетном периоде</p>
                <p style="font-weight:400; font-size: 1rem;">Из доходов физического лица, подлежащих налогообложению, исключаются 54 вида доходов указанные в статье 341 Налогового кодекса.</p>
                </div>
            ...
            <div class="popupInfo" id="infoD" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел D «Cумма налоговых вычетов, не примененных налоговым агентом»</p>
                <p style="font-weight:400; font-size: 1rem;">Указывается  сумма налоговых вычетов в соответствии со статьей 342 Налогового кодекса при их наличии в отчетном периоде. </p>
                </div>
            ...
            <div class="popupInfo" id="infoE" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел Е. Исчисление индивидуального подоходного налога (ИПН)</p>
                <p style="font-weight:400; font-size: 1rem;">Указывается сумма исчисленного индивидуального подоходного налога (далее – ИПН) с доходов, полученных в отчетном периоде.</p>
                </div>
            ...
            <div class="popupInfo" id="infoE1" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 01. Сумма исчисленного ИПН по доходам, подлежащим налогообложению самостоятельно (за исключением доходов от деятельности индивидуального предпринимателя), в том числе:</p>
                <p style="font-weight:400; font-size: 1rem;">Налоговой базой для исчисления ИПН является доход полученный за налоговый период от сдачи в аренду недвижимости, от прироста стоимости при реализации физическим лицом имущества, от прироста стоимости при передаче имущества (кроме денег) в качестве вклада в уставный капитал, а также доход от уступки права требования.</p>
                </div>
            ...
            <div class="popupInfo" id="infoE1A" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 01А. Сумма ИПН с дохода лица, занимающегося частной практикой (сумма строк графы С раздела N):</p>
                <p style="font-weight:400; font-size: 1rem;">Налоговая база для исчисления ИПН, является доход частного нотариуса, доход частного судебного исполнителя, доход адвоката, доход профессионального медиатора;</p>
                </div>
            ...
            <div class="popupInfo" id="infoE1B" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 01 В. Сумма исчисленного ИПН с суммарной прибыли КИК и ПУ КИК, за исключением зарегистрированных в государствах с льготным налогообложением</p>
                <p style="font-weight:400; font-size: 1rem;">Налоговой базой для исчисления ИПН является прибыль контролируемой иностранной компании (КИК) и финансовая прибыль Постоянных учреждений контролируемых иностранных компаний (ПУ КИК), , за исключением зарегистрированных в государствах с льготным налогообложением</p>
                </div>
            ...
            <div class="popupInfo" id="infoE1C" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 01 С. Сумма исчисленного ИПН с суммарной прибыли КИК и ПУ КИК, зарегистрированных в государстве с льготным налогообложением</p>
                <p style="font-weight:400; font-size: 1rem;">Налоговой базой для исчисления ИПН является прибыль контролируемой иностранной компании (КИК) и финансовая прибыль Постоянных учреждений контролируемых иностранных компаний (ПУ КИК), зарегистрированных в государстве с льготным налогообложением.</p>
                </div>
            ...
            <div class="popupInfo" id="infoE1D" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 01 D Сумма ИПН  с доходов из источников за пределами Республики Казахстан</p>
                <p style="font-weight:400; font-size: 1rem;">Налоговая база для исчисления ИПН:
                    <ul>
            ...
            <div class="popupInfo" id="infoE2" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 02 Зачет иностранного налога с доходов из источников за пределами Республики Казахстан (статья 259 Налогового кодекса)</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoE3" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 03 Зачет предварительных платежей</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoE4" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 04  Итого ИПН, подлежащего уплате</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoF" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">В разделе F «Сведения о приобретении (получении) имущества и об источниках покрытия расходов на приобретение имущества</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoG" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">В разделе G «Информация об отчуждении имущества»</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoH" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">В разделе H «Сведения о деньгах на банковских счетах в иностранных банках, находящихся за пределами Республики Казахстан в сумме, в совокупности превышающей тысячекратный размер МРП, установленного законом о республиканском бюджете и действующего на 31 декабря отчетного налогового периода»</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoI" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел I. Сведения о наличии дебиторской/кредиторской задолженности, в том числе за пределами Республики Казахстан
            ...
            <div class="popupInfo" id="infoJ" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел J. Сведения о наличии имущества и активов за пределами Республики Казахстан на 31 декабря отчетного налогового периода</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoK" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел К «Требование о зачете превышения по ИПН в сумме»</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoL" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Разделе L «Требование о возврате превышения по ИПН»</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoM" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">В разделе M «Согласие налогоплательщика на раскрытие сведений»</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoN" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">В разделе N «Для заполнения частными нотариусом, судебным исполнителем, адвокатом, профессиональным медиатором» </p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupInfo" id="infoO" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Раздел O. Финансовая прибыль контролируемой иностранной компании (КИК)</p>
                <p style="font-weight:400; font-size: 1rem;">
            ...
            <div class="popupCheck" id="popupComplete" style="display: none;">
                <div style="text-align: center;">
                    <p style="color:#282781; font-size:1.375rem; font-weight:400">Тестирование завершено!</p>
                    <img id="percentimg" src="{{ asset('img/sucessIcon.svg') }}" alt="">
                    <p className='element' id="percent" style="color:#282781; font-size:1.125rem; font-weight:400; margin-top: 25px; margin-bottom: 25px;"></p>
            ...
            <!-- <div class="popupCheck" id="popupCheck" style="display: none;">
                <div style="text-align: center;">
                    ...
                    <p style="color:#282781; font-size:1.125rem; font-weight:400; margin-top: 25px; margin-bottom: 25px;">Вы ответили правильно на 75%</p>
                    <button type="button" class="btn btnCustom6" onclick="location.href='index.html';">OK</button>    
                </div>
            </div> -->
            <div class="popupCheck" id="popupCheck" style="display: none;">
                <div style="text-align: center;">
                    <p style="color:#282781; font-size:1.375rem; font-weight:400">Завершить тест?</p>
                    <p style="color:#000; font-size:1.125rem; font-weight:400; margin-top: 25px; margin-bottom: 25px;">Время тестирования еще не закончилось. Уверены, что хотите завершить досрочно?</p>
