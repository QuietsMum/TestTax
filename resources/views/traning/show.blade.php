    ...
    <script>
        ...
        @if (isset($mistakes))
            ...
            for (let i=0; mistakes.length; i++) {
              ...
              document.getElementById("table_f_2f_1_img").style = "background-color: #ffcfcf";
              ...
              document.getElementById("table_f_2f_2_img").style = "background-color: #ffcfcf";
              ...
              document.getElementById("table_f_2f_3_img").style = "background-color: #ffcfcf";
