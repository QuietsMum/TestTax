    ...
    <div class="row no-gutter">
        ...
        <div class="col-sm">
                ...
                <div class="container-fluid">
                    <div class="row" style="width:100%">
                        <div class="col-sm-4" style="margin-top:1%">
                            ...
                            <span style="font-size:1.25rem; font-weight:400; color:#000;text-decoration-line: underline; margin-left: 10px;">Тренажер</span>
                        </div>
                            ...
                            <div class="row" style="float:right">
                                <div class="col-sm" style="padding-right: unset; padding-left: unset;">
                                    <div class="selectCase2">
                                        <p id="caseDiscSmall" class="selectCaseText" style="color:#160B50; font-size:1.125rem; font-weight:400; margin-bottom: 0rem; text-align:left">Кейс 1: Государственный служащий («М», ИИН 731201400135), в 2021 году</p>
                                    </div>
                                </div>
            ...
            <div class="popupInfo" id="infoB2" style="display: none;">
                ...
                <div class="infoText">
                <p style="font-weight:700; font-size: 1rem;">Строка 02. Доход, подлежащий налогообложению физическим лицом самостоятельно, в том числе (параграф 2 главы 36 Налогового кодекса):</p>
                </div>
            ...
            <div class="popupInfo" id="infoO" style="display: none;">
             ...
             <div class="popupCheck" id="popupCheck" style="display: none;">
                <div style="text-align: center;">
                    ...
                    <p id="blocksHeader" style="color:#282781; font-size:1.125rem; font-weight:400; margin-top: 25px; margin-bottom: 0;">Вы допустили ошибки в разделах:</p>
                    <p className='element' id="blocks" style="color:#e84a4a; font-size:1.125rem; font-weight:400; margin-bottom:25px"></p>
