...
<body style="background-color: #E5E5E5;">
        ...
        <div class="container-fluid">
            <div class="row" style="width:100%">
                <div class="col-sm-8" style="margin-top:1%">
                   <p style="font-size: 18px; font-weight: 400; text-decoration-line: underline;">Составление декларации о доходах и имуществе
    ...
    <div class="whiteBoxInfo">
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;">Составление декларации о доходах и имуществе физического лица (ФНО 270.00)</p>
        <p style="font-weight: 400; font-size: 18px;">Декларация состоит из 4-х страниц и 16 разделов предназначенных для детального отражения информации о доходах и имуществе физического лица (форма 270.00) (далее-Декларация).
        ...
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionA">Раздел А «Общая информация о налогоплательщике»</p>
        <p style="font-weight: 400; font-size: 18px;">в строке 1 – указывается индивидуальный идентификационный номер  (ИИН) физического лица;
        ...
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB">Раздел В «Начисленная сумма полученных  доходов»</p>
        <p style="font-weight: 400; font-size: 18px;">Годовой доход физического лица включает 18 видов доходов, согласно статье 321 Налогового кодекса, из которых 13 видов доходов облагает налоговый агент (работодатель), остальные 5 видов дохода физическое лицо может исчислить самостоятельно.
            *(Исчисление, удержание и уплата в бюджет индивидуального подоходного налога осуществляются у источника выплаты налоговым агентом по указанным доходам, в случае, если такие доходы подлежат выплате (выплачиваются) указанным налоговым агентом:
            ...
            <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB1">Строка 01. Виды дохода, подлежащего налогообложению у источника выплаты (включает доходы согласно статьи 322, 323, 324, 325, 326, 327, 328, 329 Налогового кодекса)</p>
...
      		работодателем в пользу работника;
    ...
          	- превышение суммы страховых выплат, осуществляемых страховой организацией, над суммой страховых премий, оплаченных за счет средств).
        ...
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB2">
        ...
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB2A">
        ...
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB2B">Строка 02В. Доход лица, занимающегося частной практикой</p>
        <p style="font-weight: 400; font-size: 18px; ">Отражаются доходы частного нотариуса, частного судебного исполнителя, адвоката, профессионального медиатора (статья 336 Налогового кодекса).
            *Доход лица, занимающегося частной практикой</br>
            ...
            <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB2C">Строка 02С. Доход из источников за пределами Республики Казахстан (статья 338 Налогового кодекса)
            </p>
        <p style="font-weight: 400; font-size: 18px; ">*Доходами из источников за пределами Республики Казахстан признаются все виды доходов, полученных (подлежащих получению) налогоплательщиком в течение отчетного налогового периода от лица, не являющегося налоговым агентом, и не являющихся доходами из источников в Республике Казахстан независимо от места выплаты, за исключением доходов указанных в подпунктах 1) – 16) статьи 321 Налогового кодекса.
            </p>
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionB2C">Строка 02D. Доход индивидуального предпринимателя (статья 338 Налогового кодекса)
        </p>
    <p style="font-weight: 400; font-size: 18px; ">*  1. Доход индивидуального предпринимателя, применяющего общеустановленный режим, определяется в соответствии со статьей 366 Налогового кодекса.</br>
        ...
        <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionC">Раздел С «Общая сумма корректировки дохода в соответствии со статьей 341 Налогового кодекса» налогоплательщик указывает сумму корректировки при их наличии в отчетном периоде
        </p>
    <p style="font-weight: 400; font-size: 18px; ">Из доходов физического лица, подлежащих налогообложению, исключаются 54 вида доходов указанные в статье 341 Налогового кодекса.</br>
    ...
    53) страховые премии (страховые взносы – в случае, если договором предусмотрена уплата страховых премий в рассрочку) в пределах 320-кратного размера МРП, оплаченные в течение календарного года физическим лицом-резидентом по договору накопительного страхования, заключенному на срок три года и более.<br>
     ...
     <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionD">Раздел D «Cумма налоговых вычетов, не примененных налоговым агентом»
    </p>
<p style="font-weight: 400; font-size: 18px; ">
...
<p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE">Раздел Е. Исчисление индивидуального подоходного налога (ИПН)
</p>
<p style="font-weight: 400; font-size: 18px; ">Указывается сумма исчисленного индивидуального подоходного налога (далее – ИПН) с доходов, полученных в отчетном периоде.
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE1">Строка 01. Сумма исчисленного ИПН по доходам, подлежащим налогообложению самостоятельно (за исключением доходов от деятельности индивидуального предпринимателя), в том числе:
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Налоговой базой для исчисления ИПН является доход полученный за налоговый период от сдачи в аренду недвижимости, от прироста стоимости при реализации физическим лицом имущества, от прироста стоимости при передаче имущества (кроме денег) в качестве вклада в уставный капитал, а также доход от уступки права требования.
        </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE1A">Строка 01А. Сумма ИПН с дохода лица, занимающегося частной практикой (сумма строк графы С раздела N):
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Налоговая база для исчисления ИПН, является доход частного нотариуса, доход частного судебного исполнителя, доход адвоката, доход профессионального медиатора;
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE1B">Строка 01 В. Сумма исчисленного ИПН с суммарной прибыли КИК и ПУ КИК, за исключением зарегистрированных в государствах с льготным налогообложением
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Налоговой базой для исчисления ИПН является прибыль контролируемой иностранной компании (КИК) и финансовая прибыль Постоянных учреждений контролируемых иностранных компаний (ПУ КИК), , за исключением зарегистрированных в государствах с льготным налогообложением
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE1C">Строка 01 С. Сумма исчисленного ИПН с суммарной прибыли КИК и ПУ КИК, зарегистрированных в государстве с льготным налогообложением
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Налоговой базой для исчисления ИПН является прибыль контролируемой иностранной компании (КИК) и финансовая прибыль Постоянных учреждений контролируемых иностранных компаний (ПУ КИК), зарегистрированных в государстве с льготным налогообложением.
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE1D">Строка 01 D Сумма ИПН  с доходов из источников за пределами Республики Казахстан
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Налоговая база для исчисления ИПН:
        <ul>
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE2">Строка 02 Зачет иностранного налога с доходов из источников за пределами Республики Казахстан (статья 259 Налогового кодекса)
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Отражается сумма уплаченного за пределами РК налога на доходы, аналогичного ИПН, с доходов, полученных физическим лицом-резидентом из источников за пределами РК, подлежат зачету в счет уплаты ИПН в РК
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE3">Строка 03 Зачет предварительных платежей
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Сумма налога, уплаченная трудовым иммигрантом в качестве предварительного платежа по ИПН, исчисленного в размере двух кратного размера МРП.
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionE4">Строка 04  Итого ИПН, подлежащего уплате
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Итоговая сумма ИПН, подлежащего уплате в бюджет.
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionF">В разделе F «Сведения о приобретении (получении) имущества и об источниках покрытия расходов на приобретение имущества
    </p>
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionG">В разделе G «Информация об отчуждении имущества»
    </p>
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionI">Раздел I. Сведения о наличии дебиторской/кредиторской задолженности, в том числе за пределами Республики Казахстан
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionJ">Раздел J. Сведения о наличии имущества и активов за пределами Республики Казахстан на 31 декабря отчетного налогового периода
    </p>
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionK">Раздел К «Требование о зачете превышения по ИПН в сумме»
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Предназначен для проведения зачета суммы превышения по ИПН в счет имеющейся налоговой задолженности и (или) предстоящих платежей, с отражением кода бюджетной классификации, суммы налога, суммы пени, кода органа государственных доходов.
        ! Вводится в действие с 01.01.2025 года в соответствии с Законом РК от 25.12.2017 № 121-VI
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionL">Разделе L «Требование о возврате превышения по ИПН»
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Заполняется в случае требования о возврате на банковский счет суммы превышения по ИПН, необходимо указать сумму, подлежащую возврату на банковский счет, индивидуальный идентификационный код (ИИК) бенефициара и банковский идентификационный код (БИК).
    ...
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionM">В разделе M «Согласие налогоплательщика на раскрытие сведений»
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Физическое лицо дает согласие на получение сведения о расходах на вознаграждения по ипотечным займам.
        ! Вводится в действие с 01.01.2025 года в соответствии с Законом РК от 25.12.2017 № 121-VI
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionN">В разделе N «Для заполнения частными нотариусом, судебным исполнителем, адвокатом, профессиональным медиатором»
    </p>
    <p style="font-weight: 400; font-size: 18px; ">Заполняется частным нотариусом, судебным исполнителем, адвокатом, профессиональным медиатором, где указывают месяц в котором получен доход; сумму дохода, полученного за каждый месяц отчетного налогового периода; сумма ИПН, подлежащего уплате в бюджет, за каждый месяц отчетного налогового периода.
    </p>
    <p style="font-weight: 700; font-size: 18px; text-decoration: underline;" id="sectionO">Раздел O. Финансовая прибыль контролируемой иностранной компании (КИК)
    </p>
    <p style="font-weight: 400; font-size: 18px; ">* Заполняется в случае наличия:</br>
